...
public class LandscapeSplashActivity extends Activity implements IWeak<SplashExpressAd> {
    ...
    public void onAdLoaded(SplashExpressAd splashExpressAd) {
        ...
        splashExpressAd.setAdListener(new MyAdListener(LandscapeSplashActivity.this));
    ...
    private static class MyAdListener extends AdActionListener {
        private final WeakReference<LandscapeSplashActivity> reference;

        public MyAdListener(LandscapeSplashActivity activity) {
            super(TAG);
        ...
        public void onAdSkip(int type) {
            super.onAdSkip(type);
            LandscapeSplashActivity activity = reference.get();
            if (activity != null) {
