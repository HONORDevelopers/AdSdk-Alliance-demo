...
public class SplashActivity extends BaseActivity implements IWeak<SplashExpressAd> {
    private final static String TAG = "SplashActivityTAG";

    public static final String BUTTON = "buttonId";
    public static final String I_SWITCH = "switch";
    ...
    public void initView() {
        Switch aSwitch = findViewById(R.id.ad_switch);
        aSwitch.setChecked(SPTools.getAdPrefInstance().getBoolean(SplashActivity.I_SWITCH));
        aSwitch.setOnCheckedChangeListener((buttonView, isChecked) -> {
            LogUtil.info(TAG, "ischecked: " + isChecked);
            SPTools.getAdPrefInstance().putBoolean(I_SWITCH, isChecked);
        });
    ...
    private void obtainAd() {
        ...
        SplashAdLoad load = new SplashAdLoad.Builder()
                .setSplashAdLoadListener(new SplashLoadListener(this))
                .setAdSlot(adSlot)
                .build();
        load.loadAd();
    }
     ...
     */
    @Override
    public void onAdLoaded(SplashExpressAd data) {
