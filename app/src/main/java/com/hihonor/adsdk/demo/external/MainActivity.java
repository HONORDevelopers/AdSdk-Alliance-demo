...
public class MainActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Switch switchButton = findViewById(R.id.switch_image_load_button);
        boolean isCheckedImageLoaderSwitchChecked =
                SPTools.getAdPrefInstance().getBoolean(Constants.SP_SUPPORT_SDK_IMAGE_LOADER, false);
        switchButton.setChecked(isCheckedImageLoaderSwitchChecked);
        switchButton.setOnCheckedChangeListener((buttonView, isChecked) -> {
            isSwitchChecked = isChecked;
            SPTools.getAdPrefInstance().putBoolean(Constants.SP_SUPPORT_SDK_IMAGE_LOADER, isSwitchChecked);
        });
