...
import com.hihonor.mms.ads.ipc.bean.AdSrc;
    ...
    private final PictureTextAdLoadListener mAdLoadListener = new PictureTextAdLoadListener() {
        ...
        public void onAdLoaded(List<PictureTextExpressAd> adViewList) {
            ...
            for (int i = 0; i < adViewList.size(); i++) {
                ...
                AdSrc adSrc = expressAd.getAdSrc();
                if (adSrc != null) {
                    LogUtil.info(TAG, "adLogoSrc: " + adSrc.getAdSrcLogo() + System.lineSeparator()
                            + "adSrcText: " + adSrc.getAdSrcText());
                }
