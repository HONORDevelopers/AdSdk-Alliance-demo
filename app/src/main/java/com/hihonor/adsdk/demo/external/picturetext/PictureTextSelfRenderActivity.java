    ...
    private final PictureTextAdLoadListener mAdLoadListener = new PictureTextAdLoadListener() {
        ...
        public void onAdLoaded(List<PictureTextExpressAd> adViewList) {
            ...
            for (int i = 0; i < adViewList.size(); i++) {
                ...
                expressAd.setDownloadStatusChange(status -> LogUtil.info(TAG,
                        "package: " + expressAd.getAppPackage() + " status: " + status));
                ...
                expressAd.setAdListener(new AdListener() {
                    ...
                    public void onAdClosed() {
                        ...
                        Toast.makeText(PictureTextSelfRenderActivity.this, getString(R.string.app_ad_close_tip),
                                Toast.LENGTH_SHORT).show();
                    }
                    ...
                    public void onAdClicked() {
                        ...
                        Toast.makeText(PictureTextSelfRenderActivity.this, getString(R.string.ad_clicked),
                                Toast.LENGTH_SHORT).show();
                    }
                    ...
                    public void onAdImpression() {
                        ...
                        Toast.makeText(PictureTextSelfRenderActivity.this, getString(R.string.ad_impression_success),
                                Toast.LENGTH_SHORT).show();
                    }
                    ...
                    public void onMiniAppStarted() {
                        ...
                        Toast.makeText(PictureTextSelfRenderActivity.this, getString(R.string.miniapp_start),
                                Toast.LENGTH_SHORT).show();
                    }
