...
public class InterstitialActivity extends BaseActivity implements IWeak<InterstitialExpressAd> {
    ...
    private void obtainAd() {
        ...
        InterstitialAdLoad load = new InterstitialAdLoad.Builder()
                .setInterstitialAdLoadListener(new InterstitialLoadListener(this)) // 必填，注册广告加载状态监听器。
     ...
     * 广告加载状态监听器
     */
    private static class InterstitialLoadListener extends WeakLoad<InterstitialExpressAd,
                IWeak<InterstitialExpressAd>> implements InterstitialAdLoadListener {
        public InterstitialLoadListener(IWeak<InterstitialExpressAd> item) {
            super(item);
        }
    }
     ...
     */
    @Override
    public void onAdLoaded(InterstitialExpressAd data) {
    ...
    private void showAd(InterstitialExpressAd interstitialExpressAd) {
        ...
        mInterstitialExpressAd.setAdListener(new MyAdListener(mInterstitialExpressAd));
    ...
    private static class MyAdListener extends AdActionListener {
        private final WeakReference<InterstitialExpressAd> mWeakReference;

        MyAdListener(InterstitialExpressAd interstitialExpressAd) {
            super(TAG);
            mWeakReference = new WeakReference<>(interstitialExpressAd);
        }

        @Override
        public void onAdClosed() {
            super.onAdClosed();
            InterstitialExpressAd expressAd = mWeakReference.get();
            if (expressAd != null) {
                expressAd.release();
            }
        }
