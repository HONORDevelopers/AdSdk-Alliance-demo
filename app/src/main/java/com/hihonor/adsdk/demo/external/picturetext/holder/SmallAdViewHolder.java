...
public class SmallAdViewHolder extends BaseViewHolder {
    ...
    public void bindData(@NonNull PictureTextExpressAd baseAd) {
        ...
        // 根布局左padding边距
        float paddingMaxStart = context.getResources().getDimension(R.dimen.honor_ads_magic_dimens_max_start);
        // 根布局左padding边距
        float paddingMaxEnd = context.getResources().getDimension(R.dimen.honor_ads_magic_dimens_max_end);
        // 三图每个图片的间距
