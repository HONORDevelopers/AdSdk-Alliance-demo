 ...
 */
public class BannerDefaultActivity extends BaseActivity implements IWeak<BannerExpressAd> {
    ...
    private void obtainAd() {
        ...
        BannerAdLoad load = new BannerAdLoad.Builder()
                .setBannerAdLoadListener(new BannerLoadListener(this)) // 注册广告加载状态监听器。
